...
function MainPost() {
  ...
  const renderedItems = post.map((items, index) => {
    return <TripPost trip={items} key={index} />;
  });
  ...
  return (
    <div className="Mainpage">
      <div className="mainleft">
        ...
        <div className="sidebtndiv">
          <button className="sidebtn" onClick={() => navigate("/searchpost")}>
            {" "}
        ...
        <div className="sidebtndiv">
          <button className="sidebtn" onClick={() => navigate("/msg")}>
            <img src={chat} alt="messages" className="image" />
            <h2>Messages</h2>{" "}
          </button>
        </div>

        <div className="sidebtndiv">
          <button className="sidebtn" onClick={() => navigate("/postbookmark")}>
            {" "}
            <img src={bookmark} alt="home" className="image" />
            <h2>Bookmarks</h2>{" "}
          </button>
        </div>
